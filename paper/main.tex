...
\author{\IEEEauthorblockN{Athoy Kanti Ray}
\IEEEauthorblockA{American International University-Bangladesh (AIUB)\\
Email: athoykanti.roy1612@gmail.com}}

\maketitle

\begin{tcolorbox}[colback=gray!10,colframe=black,title=Contributions,fonttitle=\bfseries]
This work was independently designed, implemented, evaluated, and
written by Athoy Kanti Ray. Specifically: the TD-FALE-GAN
...
\ref{sec:discussion} ("Reproducibility and integrity") were all
performed by the sole author. AI assistance (Claude, Anthropic)
was used as a coding and writing aid throughout, and separately as
an independent referee to produce the AI Review Report in this
submission package (Appendix~\ref{app:review}); all experimental
results, code, and reported numbers were verified by the author
against the underlying logs, checkpoints, and CSV outputs before
inclusion, consistent with the reproducibility discussion in
...
\textbf{Conflicts of Interest.} The author declares no conflict
of interest.
